...
<body>
    <div class="container d-flex align-items-center justify-content-center vh-100">
        <div class="card p-2">
            ...
            <form id="cadastroForm" action="entrar.php" method="post">
                <div class="mb-3">
                    <label for="email" class="form-label">E-mail</label>
                    <input type="email" class="form-control focus-ring focus-ring-dark " id="email" name="email" placeholder="Digite o seu e-mail" required style="border-color: black;"/>
                </div>
                <div class="mb-3 position-relative">
                    <label for="senha" class="form-label">Senha</label>
                    <input type="password" class="form-control focus-ring focus-ring-dark" id="senha" name="senha" placeholder="Digite a sua senha" required style="border-color: black;"/>
